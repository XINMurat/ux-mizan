...
| Kurtarma rampaları R-00…R-13, model hata sınıfları, kapanış çizelgesi | [`references/recovery.md`](../../skill/ux-mizan/references/recovery.md) |
...
|---|---|---|
| `ux_validate.py` | U1–U14 hükümleri, W1–W4 uyarıları | — (denetler, iddia etmez) |
